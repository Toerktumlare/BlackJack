...
//        final Game game = new Game.BlackJackSetup(DeckBuilder.get(Decks.Scenarios.PLAYER_WINS), Players.PLAYER_1.getPlayer()).run();
//
...
//        final Game game = new Game.BlackJackSetup(DeckBuilder.get(Decks.Scenarios.PLAYER_LOSS), Players.PLAYER_1.getPlayer()).run();
...
//        final Game game = new Game.BlackJackSetup(DeckBuilder.get(Decks.Scenarios.PLAYER_DRAW), Players.PLAYER_1.getPlayer()).run();
...
//        final Game game = new Game.BlackJackSetup(DeckBuilder.get(Decks.Scenarios.PLAYER_BLACKJACK_AFTER_DEAL), Players.PLAYER_1.getPlayer()).run();
...
//        final Result result = new Game.BlackJackSetup(DeckBuilder.get(Decks.Scenarios.PLAYER_BLACKJACK_DEALER_TEN), Players.PLAYER_1.getPlayer()).run();
//        assertEquals(1, result.getPlayers().get(0).getHands().size());
//        assertEquals(1, result.getDealer().getHands().size());
//        assertEquals(1, result.getStatistics().getWins());
//        assertEquals(1, result.getStatistics().getBlackJacks());
//        assertEquals(1, result.getPlayers().get(0).getStatistics().getWins());
//        assertEquals(1, result.getPlayers().get(0).getStatistics().getBlackJacks());
//        assertEquals(0, result.getDealer().getStatistics().getWins());
//        assertEquals(0, result.getGame().getDealer().getStatistics().getBlackJacks());
//    }
}
